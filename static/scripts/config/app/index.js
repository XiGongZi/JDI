...
define('work/public/titleBar_eyeDepa/c/main',[
    'require',
    "jquery",
], function(require,$) {
    'use strict';
...
define('work/public/titleBar/c/main',[
    'require',
    "jquery",
], function(require,$) {
    'use strict';
        ...
        str:function(json){
            ...
            if(json.returnFlag){
                $.each(json.orderList,function(i,n){
                    str00 += `<a href="${n.href}" class="anBtn-titleBar">${n.name}</a>`
                });
            }else{
            }
            return `	<div class="row titleBar">
                            <div class="col-md-1 col-xs-1"></div>
...
define('work/public/showCenterImg/c/main',[
    'require',
    "jquery",
    "app/setPlc_0.0.1"
...
define('work/public/login/c/main',[
    'require',
    "jquery",
    "app/setPlc_0.0.1"
], function(require,$,setPlc) {
...
define('work/public/footer/c/main',[
    'require',
    "jquery",
], function(require,$) {
    'use strict';
...
define('work/host/index/C/main',[
    ...
    /* 组件处理单元 开始 titleBar_eyeDepa*/
        var json01 = AJAX.userList;
        //此处通过返回的json去获取相应的字符串
        var str01 = titleBar_eyeDepa.main.str(json01);
        //将字符串添加到dom里
        $(".TB").prepend(str01);
        //为此节点绑定特定事件
    ...
    /* 组件处理单元 开始 showCenterImg*/
        var imgAdd = AJAX.imgAdd_body;
        //此处通过返回的json去获取相应的字符串
        var str03 =showCenterImg.main.str(imgAdd);
        //将字符串添加到dom里
        $(".TB").append(str03);
        //为此节点绑定特定事件
    ...
    /* 组件处理单元 开始 footer*/
        var imgAdd1 = AJAX.imgAdd_footer;
        //此处通过返回的json去获取相应的字符串
        var str04 =footer.main.str(imgAdd1);
        //将字符串添加到dom里
        $("footer").append(str04);
        //为此节点绑定特定事件
