...
define('work/host/contactUs/C/main',[
    'require',
    "app/PKG_0.0.1",
    ...
    /* 组件处理单元 开始 login*/
        let imgAdd2 = AJAX.imgAdd_login;
        //此处通过返回的json去获取相应的字符串
        let str05 =login.main.str(imgAdd2);
        //将字符串添加到dom里
        $("body").append(str05);
        //为此节点绑定特定事件(显示login)
        let hisUrl = $(".titleBar-main>a:eq(2)").attr("href");
