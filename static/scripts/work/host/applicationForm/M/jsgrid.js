...
function useTable_addInfo(json){
    ...
    var jsGridInfo = {
        ...
        required:true,
        fields: [
            { name: "申请单号", type: "number", readOnly: true, width:50,  },
            { name: "部门", type: "text", width:100,  },
            { name: "项目部", type: "text", width:100,  },
            { name: "总包合同号", type: "text", width:100,  },
            { name: "类型", type: "text", width:60,  },
            { name: "备注", type: "text", width:30,  },
