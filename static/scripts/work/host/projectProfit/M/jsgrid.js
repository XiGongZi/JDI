...
function useTable_addInfo(json){
    ...
    var jsGridInfo = {
        ...
        required:true,
        fields: [
            { name: "项目名称", type: "number", readOnly: true, width:50,  },
            { name: "项目负责人", type: "text", width:100,  },
            { name: "签订时间", type: "text", width:100,  },
            { name: "合同总额", type: "text", width:100,  },
            { name: "分包及采购合同额", type: "text", width:60,  },
            { name: "收入金额", type: "text", width:30,  },
            { name: "收应付金额", type: "text", width:50,  },
            { name: "支出余额", type: "text", width:30,  },
            { name: "应付余额", type: "text", width:30,  },
            { name: "利润", type: "text", width:30,  },
