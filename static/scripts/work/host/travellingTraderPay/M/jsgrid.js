...
function useTable_addInfo(json){
    ...
    var jsGridInfo = {
        ...
        required:true,
        fields: [
            { name: "客商名称", type: "number", readOnly: true, width:50,  },
            { name: "合同签订额", type: "text", width:100,  },
            { name: "应付额", type: "text", width:100,  },
            { name: "付款金额", type: "text", width:100,  },
            { name: "差额", type: "text", width:60,  },
