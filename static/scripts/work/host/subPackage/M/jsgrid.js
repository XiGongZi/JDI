...
function useTable_addInfo(json){
    ...
    var jsGridInfo = {
        ...
        required:true,
        fields: [
            { name: "分包合同号", type: "text", readOnly: true, width:100,  },
            { name: "总包合同号", type: "text", width:100,  },
            { name: "客商名称", type: "text", width:100,  },
            { name: "合同额", type: "text", width:100,  },
            { name: "税率", type: "text", width:30,  },
            { name: "客商负责人", type: "text", width:60,  },
            { name: "状态", type: "text", width:30,  },
            { name: "制单人", type: "text", width:60,  },
            { name: "制单时间", type: "text", width:80,  },
